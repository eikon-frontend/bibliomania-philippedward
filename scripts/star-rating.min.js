...
monImage.addEventListener("click", function () {
    if (monImage.src.includes("categorie.svg")) {
        monImage.src = "././img/Ajouter.svg";
        monImage.alt = "Image 2";
    } else {
        monImage.src = "././img/categorie.svg";
        monImage.alt = "Image 1";
    }
});

function changerTexteEtCouleur() {
    var bouton = document.getElementById("bouton-relire");
    if (bouton.textContent === "Relire") {
        bouton.textContent = "Lire";
        bouton.style.backgroundColor = "#ffff";
        bouton.style.color = "#3b3b3b";
    } else {
        bouton.textContent = "Relire";
        bouton.style.backgroundColor = "#ffff";
        bouton.style.color = "#3b3b3b";
...
function changerTexteEtCouleur2() {
    var bouton = document.getElementById("bouton-lire");
    if (bouton.textContent === "Lu") {
        bouton.textContent = "À lire";
        bouton.style.backgroundColor = "#3b3b3b";
        bouton.style.color = "#ffff";

    } else {
        bouton.textContent = "Lu";
        bouton.style.backgroundColor = "#ffff";
        bouton.style.color = "#3b3b3b";
...
function changerTexteEtCouleur2() {
    ...
    changerImage(); // Appel de la fonction pour changer l'image
}

function changerImage() {
    var monImage2 = document.getElementById("monImage2");
    if (monImage2.src.includes("Vector.svg")) {
        monImage2.src = "././img/time.svg";
        monImage2.alt = "Image 2";
    } else {
        monImage2.src = "././img/Vector.svg";
        monImage2.alt = "Image 3";
    }
}